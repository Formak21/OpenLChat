...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.SendButton.setGeometry(QtCore.QRect(420, 320, 85, 30))
        self.SendButton.setObjectName("SendButton")
        self.ExitButton = QtWidgets.QPushButton(self.centralwidget)
        self.ExitButton.setGeometry(QtCore.QRect(420, 10, 85, 30))
        self.ExitButton.setObjectName("ExitButton")
        self.ReloadButton = QtWidgets.QPushButton(self.centralwidget)
        self.ReloadButton.setGeometry(QtCore.QRect(420, 70, 85, 30))
        ...
        self.ReconnectButton.setGeometry(QtCore.QRect(420, 40, 85, 30))
        self.ReconnectButton.setObjectName("ReconnectButton")
        self.neko = QtWidgets.QLabel(self.centralwidget)
        self.neko.setGeometry(QtCore.QRect(420, 100, 80, 220))
        self.neko.setText("")
